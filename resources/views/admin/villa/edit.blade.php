                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="editNamaVilla" required name="nama_villa" class="form-control"
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-7 mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="harga" id="editHarga" required name="ulangi_password"
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" name="luas" id="editLuas" class="form-control"
                                    aria-label="Text input with dropdown button" placeholder="Masukkan Luas Villa"
                                    style="width: 65%;" />
                                <select class="form-select" name="satuan" id="editSatuan" style="width: 35%;">
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <input type="number" id="editJmlKmrTidurId" required name="jml_kmr_tidur"
                                class="form-control" placeholder="0" />
                        </div>
                        <div class="col mb-0">
                            <label class="form-label">Jumlah Kamar Mandi</label>
                            <input type="number" id="editJmlKmrMandiId" required name="jml_kmr_mandi"
                                class="form-control" placeholder="0" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <div class="input-group input-group-merge speech-to-text">
                                <textarea class="form-control" id="editUraian" name="uraian" placeholder="Say it" rows="2"></textarea>
