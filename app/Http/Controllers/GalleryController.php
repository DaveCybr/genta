...
class GalleryController extends Controller
{
    ...
    {
        $data = DB::table('tbl_gallery')->first();
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            DB::table('tbl_gallery')->where('id_gallery', $id)->update([
            ...
            $updatedgallery = DB::table('tbl_gallery')->where('id_gallery', $id)->first();

            return response()->json(['status' => 'success', 'message' => 'Data berhasil diperbarui', 'gallery' => $updatedgallery]);
        } catch (\Throwable $th) {
